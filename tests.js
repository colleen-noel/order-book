...
describe('Order Book', () => {
  describe('reconcileOrder', () => {
    ...
    it.skip('Extra Credit 1: it fulfills a mismatched order when both parties benefit', () => {
    ...
    it('Extra Credit 2: it does not fulfill a mismatched order when it does not benefit both parties', () => {
